...
The most common jobs on the Bluemoon cluster are serial jobs, which run as a single process. We recommend that you begin with 1 node and 2 processes. For example:
